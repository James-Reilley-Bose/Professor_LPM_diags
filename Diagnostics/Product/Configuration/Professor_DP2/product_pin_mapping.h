...
#define PSOC_READ_IRQ_PORT_SOURCE                EXTI_PortSourceGPIOD
#define PSOC_READ_IRQ_LINE                       EXTI_Line3
#define PSOC_READ_IRQ_CHANNEL                    EXTI3_IRQn
#define PSOC_READ_IRQ_HANDLER                    Psoc_Int_Handler
#define PSOC_READ_INT_GPIO_BANK                  GPIOD
#define PSOC_READ_INT_GPIO_PIN                   3
...
#define POWER_HDMI_5V_TVOUT_EN_BANK             GPIOC
#define POWER_HDMI_5V_TVOUT_EN_PIN              13
#define POWER_HDMI_EN_BANK                      GPIOC
#define POWER_HDMI_EN_PIN                       15
#define POWER_RIVIERA_EN_BANK                   GPIOD
#define POWER_RIVIERA_EN_PIN                    2
...
#define RIVIERA_CTS_IRQ_PORT_SOURCE             EXTI_PortSourceGPIOA
#define RIVIERA_CTS_IRQ_LINE                    EXTI_Line1
#define RIVIERA_CTS_IRQ_LINE_NUM                1
#define RIVIERA_CTS_IRQ_CHANNEL                 EXTI1_IRQn
#define RIVIERA_CTS_IRQ_PIN_MASK                GPIO_Pin_1
#define RIVIERA_CTS_IRQ_HANDLER                 EXTI1_IRQHandler
#define RIVIERA_CTS_IRQ_ACTIVE_STATE            GPIO_HIGH
...
#define RIVIERA_PON_1_ACTIVE_STATE              GPIO_HIGH
...
#define RIVIERA_SYSCLK_EN_BANK                  GPIOD
#define RIVIERA_SYSCLK_EN_PIN                   1
...
#define CEC_CTRL_RST_L_GPIO_BANK               GPIOD      //GPIOC
#define CEC_CTRL_RST_L_GPIO_PIN                7          //10
#define CEC_CTRL_RST_L_GPIO_PIN_MASK           GPIO_Pin_7 //GPIO_Pin_10
...
#define SPI_SLAVE_CTS_GPIO_BANK                   GPIOA
#define SPI_SLAVE_CTS_GPIO_PIN                    1
#define SPI_SLAVE_CTS_IRQ_PORT_SOURCE             EXTI_PortSourceGPIOA
#define SPI_SLAVE_CTS_IRQ_LINE                    EXTI_Line1
#define SPI_SLAVE_CTS_IRQ_LINE_NUM                1
#define SPI_SLAVE_CTS_IRQ_CHANNEL                 EXTI1_IRQn
#define SPI_SLAVE_CTS_IRQ_PIN_MASK                GPIO_Pin_1
#define SPI_SLAVE_CTS_IRQ_HANDLER                 EXTI1_IRQHandler
...
#define RADIO_IRQ_GPIO_PIN_MASK                GPIO_Pin_6
#define DWAM_INTERRUPT_LINE                    EXTI_Line6
#define DWAM_INTERRUPT_PORT_SOURCE             EXTI_PortSourceGPIOD
#define DWAM_INTERRUPT_LINE_NUM                6 /* EXTI_LINE1 */
#define DWAM_INTERRUPT_PIN_MASK                RADIO_IRQ_GPIO_PIN_MASK
#define DWAM_INTERRUPT_CHANNEL                 EXTI9_5_IRQn
#define DWAM_INTERRUPT_BANK                    RADIO_IRQ_GPIO_BANK
#define DWAM_INTERRUPT_PIN                     RADIO_IRQ_GPIO_PIN
#define DWAM_INTERRUPT_HANDLER                 EXTI9_5_IRQHandler
...
#define DSP_RECOVERY_L_BANK                   GPIOC
#define DSP_RECOVERY_L_PIN                    0
...
#define HDMI_I2C_SPEED                         I2C_MASTER_CLOCK_FAST_SPEED_HZ
...
#define EARC_IRQ_EXTI_PORT_SOURCE              EXTI_PortSourceGPIOD
#define EARC_IRQ_LINE                          EXTI_Line13
#define EARC_IRQ_CHANNEL                       EXTI15_10_IRQn
#define EARC_IRQ_HANDLER                       EXTI15_10_IRQHandler
...
#define WIRED_ID_INTERRUPT_BANK                  GPIOE
#define WIRED_ID_INTERRUPT_PIN                   10
#define WIRED_ID_INTERRUPT_EXTI_PORT_SOURCE      EXTI_PortSourceGPIOE
#define WIRED_ID_INTERRUPT_LINE                  EXTI_Line10
#define WIRED_ID_INTERRUPT_CHANNEL               EXTI15_10_IRQn
#define WIRED_ID_INTERRUPT_HANDLER               EXTI15_10_IRQHandler

/**********************************************************
* Remote
**********************************************************/
#define REMOTE_IRQ_BANK                         GPIOB
#define REMOTE_IRQ_PIN                          9
#define REMOTE_INTERRUPT_PORT_SOURCE            EXTI_PortSourceGPIOB
#define REMOTE_INTERRUPT_LINE                   EXTI_Line9
#define REMOTE_INTERRUPT_LINE_NUM               9
#define REMOTE_INTERRUPT_PIN_MASK               GPIO_Pin_9
#define REMOTE_INTERRUPT_CHANNEL                EXTI9_5_IRQn
#define REMOTE_INTERRUPT_HANDLER                EXTI9_5_IRQHandler

#define REMOTE_UPDATE_BL_BANK                   GPIOB
#define REMOTE_UPDATE_BL_PIN                    9
#define REMOTE_RESET_L_BANK                     GPIOC
#define REMOTE_RESET_L_PIN                      14
#define REMOTE_CHIP_SELECT_BANK                 GPIOD
#define REMOTE_CHIP_SELECT_PIN                  14
#define REMOTE_SPI_BUS_NUM                      3
#define REMOTE_SPI_BUS                          SPI3

#define MIC_MUTE_BANK                           GPIOB
#define MIC_MUTE_PIN                            6

#define MIC_DETECT_BANK                         GPIOD
#define MIC_DETECT_PIN                          5
