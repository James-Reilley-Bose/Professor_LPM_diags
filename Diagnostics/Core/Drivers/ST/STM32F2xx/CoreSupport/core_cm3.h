...
/* ##################################    InInterrupt function  ############################################ */

/**
 * @brief  Test whether or not an interrupt is currently executing.
 *
 * Useful for testing deep in the stack, where that might not be otherwise known.
 */
static __INLINE int InInterrupt(void)
{
