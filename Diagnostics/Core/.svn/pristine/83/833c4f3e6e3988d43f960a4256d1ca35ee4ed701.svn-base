/**
  ...
  *-----------------------------------------------------------------------------
  *        SYSCLK(Hz)                             | X (can be defined, see device configs)
  *-----------------------------------------------------------------------------
  *        HCLK(Hz)                               | X
  *-----------------------------------------------------------------------------
  *        AHB Prescaler                          | 1
  ...
  *-----------------------------------------------------------------------------
  *        PLL_M                                  | Varies based on sysclk freq
  *-----------------------------------------------------------------------------
  *        PLL_N                                  | Varies based on sysclk freq
  *-----------------------------------------------------------------------------
  *        PLL_P                                  | Varies based on sysclk freq
  *-----------------------------------------------------------------------------
  *        PLL_Q                                  | Varies based on sysclk freq
  *-----------------------------------------------------------------------------
  *        PLLI2S_N                               | 216
  *-----------------------------------------------------------------------------
  *        PLLI2S_R                               | 4
...
/** @addtogroup STM32F2xx_System_Private_Variables
  ...
  */
  ...
  uint32_t SystemCoreClock = 120000000;  // this will get updated after the clocks are configured
