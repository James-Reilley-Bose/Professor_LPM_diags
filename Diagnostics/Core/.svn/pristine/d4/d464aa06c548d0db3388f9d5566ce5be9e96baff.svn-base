...
#define CHIPCON_WRITE_SINGLE 0x00
#define CHIPCON_WRITE_BURST 0x40
#define CHIPCON_READ_SINGLE 0x80
#define CHIPCON_READ_BURST  0xC0

#define CHIPCON_CHECK_STATUS_TX_FIFO CHIPCON_WRITE_SINGLE
#define CHIPCON_CHECK_STATUS_RX_FIFO CHIPCON_READ_SINGLE
